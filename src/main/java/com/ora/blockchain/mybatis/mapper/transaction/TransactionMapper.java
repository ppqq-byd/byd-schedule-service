...
public interface TransactionMapper {
    ...
    public List<Transaction> queryTransactionListByBlockHash(@Param("database") String database, @Param("blockHash") String blockHash,@Param("coinbase") Integer coinbase);
